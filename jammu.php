...
<body>
      <h1>JAMMU AND KASHMIR</h1>
       <P class="para">
        Hill stations in Jammu and Kashmir are incredible India's paradise. Each season here has its own peculiar character and distinctive charm. Snow-caped mountains, serene valleys, picturesque skies and pristine lakes make Jammu and Kashmir a major tourist attraction. Main tourist places in Kashmir are Srinagar, Sonamarg and Pahalgam. Gulmarg and Patnitop are well known for adventure sports. Ladakh region is also popular among tourists for its landscapes, monasteries and lakes. Jammu and Kashmir is indeed nature's beauty at its very best. 

      </P>

  <div class="g1">
    <div class="u2">
        <div><img class="u1" src="gul.webp" alt="error"></div>
       <div class="p1">
        <b>GULMARG</b> 
  ...
  <div class="g2">
   ...
   <b>SANASAR</b> 
    ...
    <div >
      <img  class="u3"src="sanas.jpg" alt="error">
    </div>
   </div>
  </div>
  ...
  <div class="g3">
   <div class="u5">
    <div>
      <img  class="u6"src="nub.jpg" alt="error">
     </div>
     <div class="p3">
       <b>NUBRA</b>
  ...
  <div>
    <div class="u7">
     ...
     it is a famous hill station in the Udhampur district of Jammu & Kashmir, known for endless meadows and panoramic views of the snow-capped peaks of the Himalayas. Along with the widespread abundance in sceneries, Patnitop is known for activities like skiing and trekking as well as water springs.Patnitop offers adventure activities like paragliding, trekking, skiing etc.Sanasar, located 17 kms away is also popular for a paragliding base, golf courses along with extended sightseeing options.Nathatop, located approximately 14 km away from Patnitop is known for panoramic view of the snow-covered peaks and also as the take off site for Paragliding.Shiva Garh is situated around 11 kilometres away from Patnitop, at an altitude of almost 3500 meters. It makes for a short but an exhilarating trek experience. 
      ...
      <div>
        <img class=" u8"src="ptani.webp" alt="error">
