...
<body>
  ...
  <div class="g3">
   <div class="u5">
    <div>
      <img  class="u6"src="kur.jpg" alt="error">
     </div>
     <div class="p3">
        <B>KURSEONG</B> 
  ...
  <div>
    <div class="u7">
      <div class="p4">
         <b>DOOARS</b> starting from river Teesta in the East to river Sankoshi in the west, Dooars is a local name given to the floodplains of North-East India around Bhutan. The name 'Dooars' has emerged from 'door' as Dooars is the gateway to Bhutan.
      ...
      <div>
        <img class=" u8"src="doo.jpg" alt="error">
