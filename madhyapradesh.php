...
<head>
    ...
    <link rel="stylesheet" href="uttrakhand.css">
    <title>Document</title>
</head>
<body>
      <h1> MADHYA PRADESH</h1>
       <P class="para"> 
        Hill Stations in Madhya Pradesh, are tucked away in an inviting blanket of earthly glory and are known to be a gateway for those seeking a rejuvenating break. From the Bollywood favorite Khandala to the serene land of Pachmarhi, Madhya Pradesh gives you the perfect opportunity to unwind in the lap of nature.Amarkantak, the highest hill station in Madhya Pradesh, is home to some of the most majestic temples that allure the heart of those seeking a spiritual gateway. With an outpouring of flora, fauna and unfathomable astounding pastures, Auli is the hill station for every wanderlust hit soul out there. You can additionally visit Lonavala, which is situated amidst wild forests and beautiful landscapes and offers a positive healing effect to the withered souls. So hit these hill stations now that are bound to cast a spell on you with their natural beauty and neverending charm.
       </P>

  <div class="g1">
    <div class="u2">
        <div><img class="u1" src="AMAR.jpg" alt="error"></div>
       <div class="p1">
        <b>AMARKANTAK</b> This hill station is famous for its forest area. Another name is ‘Teerthraj’ which means that ‘the king of pilgrimages’. It has a unique speciality that the three rivers, namely the Narmada, Son and Johila have their origin in the mountains of Amarkantak. It is a place for trees of medicinal value. The green environment makes a person away from a pollution and busy world. It is one of the educational research places. The Indira Gandhi National Tribal University was declared by the parliament to provide education and research for the tribal communities. It consists of twenty-eight departments such as undergraduate, postgraduate and PhD. Here the population is nearly five thousand. 
