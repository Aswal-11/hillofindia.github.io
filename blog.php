...
<body>
    ...
    <h1>Most Essential Things To Carry While Travelling To Hill Station In 2022</h1>
    
    <p class="a"> <strong> The key is to pack smart! Think before you pack and you will agree that the below-given travel packing tips are the only things to carry while travelling to hill station.</strong></p>
    <img class="img1" src="b1.jpg">
    
    <div class="head"> <strong>1. Woolens – You knew It, Didn’t You?</strong> </div>
    <img class="img2"src="wool.jpg" alt="error">
    <p class="b">
    ...
    <div class="head"> <strong>2. Good Shoes – Too Much Walking Is Involved</strong> </div>
    <img class="img2"src="shoes.jpeg" alt="error">
    <p class="b">
    ...
    <div class="head"> <strong>3. Medicines – To Fight Cold</strong> </div>
    <img class="img2"src="medi.webp" alt="error">
    <p class="b">
    ...
    <div class="head"> <strong>4. Thermal Water Bottle – Hydration Is A Must</strong> </div>
    <img class="img2"src="bottle.webp" alt="error">
    <p class="b">
        Though there are small taverns and food stalls on the way and uphill, it’s better to carry your own sipper. It’s important to keep yourself hydrated throughout the journey especially while you are on a hike or a trail. Fill your bottle with water or any hot beverage of your choice and keep sipping on the go. A thermal water bottle that can keep your drinks hot for a long time is the best option. Go for a leak-proof light-weight bottle.
    </p>
    
    <div class="head"> <strong>5. Cash – ATMs Are Not Always Available</strong> </div>
    <img class="img2"src="Rupee.jpg" alt="error">
    <p class="b">
    ...
    <div class="head"> <strong>6. Winter Boots – To Keep Your Feet Warm</strong> </div>
    <img class="img2"src="boots.jpg" alt="error">
    <p class="b">
    ...
    <div class="head"> <strong>7. Deodorant & Dry Shampoo – Hate To Take A Bath</strong> </div>
    <img class="img2"src="NoBath.webp" alt="error">
    <p class="b">
